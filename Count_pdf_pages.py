...
Report = open(f'{dirPathTo}/Count_pages_report.csv', 'w')
#Main loop
...
AllPages = f"Sum of all pages |{str(pdf_pages)}\n\nBelow list of all documents\n \n"
#Save report
